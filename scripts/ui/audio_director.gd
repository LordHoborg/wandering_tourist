...
const CUES: Dictionary = {
	...
	&"coin_collected": [[523.0, 0.06], [659.0, 0.08], [784.0, 0.12]],
	&"bonus_collected": [[330.0, 0.07], [440.0, 0.08], [587.0, 0.13]],
	&"coin_bonus_claimed": [[392.0, 0.08], [523.0, 0.08], [659.0, 0.08], [880.0, 0.18]],
}
