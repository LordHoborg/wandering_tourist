...
Scenes, scripts, resources, autoloads, signals, save strategy, input mapping, UI composition, test approach, and Android export configuration are intentionally deferred until approved design and architecture phases.
